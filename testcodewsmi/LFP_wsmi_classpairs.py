...
results_to_plot = {tau: copy.deepcopy(lr_split_structure) for tau in [64, 32, 16, 8]}

for tau, idx in zip([64, 32, 16, 8], range(4)):
    for class_left in classes_left:
        for class_right in classes_right:
...
for class_left in classes_left:
    for class_right in classes_right:
        for key in ['left_attleft', 'right_attleft', 'left_attright', 'right_attright']:
            results_to_plot[64][f'left_class_{class_left}'][f'right_class_{class_right}'][key] = wsmi_means[f'left_class_{class_left}'][f'right_class_{class_right}'][key][3]
            results_to_plot[32][f'left_class_{class_left}'][f'right_class_{class_right}'][key] = wsmi_means[f'left_class_{class_left}'][f'right_class_{class_right}'][key][2]
            results_to_plot[16][f'left_class_{class_left}'][f'right_class_{class_right}'][key] = wsmi_means[f'left_class_{class_left}'][f'right_class_{class_right}'][key][1]
            results_to_plot[8][f'left_class_{class_left}'][f'right_class_{class_right}'][key] = wsmi_means[f'left_class_{class_left}'][f'right_class_{class_right}'][key][0]
