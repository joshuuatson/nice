...
print('left_input_SP_attleft_all 00 raw =', left_input_SP_attleft_all[f'left_class_{0}'][f'right_class_{0}'])
print('left_input_SP_attleft_all 01 raw =', left_input_SP_attleft_all[f'left_class_{0}'][f'right_class_{1}'])
...
print('left_input_SP_attleft_all 00 reshaped = ', left_input_SP_attleft_all[f'left_class_{0}'][f'right_class_{0}'])
print('left_input_SP_attleft_all 01 reshaped = ', left_input_SP_attleft_all[f'left_class_{0}'][f'right_class_{1}'])
